...
const initialOvertimeTypes: OvertimeType[] = [
  {
    id: "ot-type-1",
    code: "OT-N",
...
export interface OvertimeSliceState {
...
export const createOvertimeSlice: StateCreator<OvertimeSliceState> = (set) => ({
  ...
  addOvertime: (overtime) => {
    ...
    const startParts = overtime.startTime.split(':');
    const endParts = overtime.endTime.split(':');
